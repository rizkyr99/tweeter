...
function About() {
  return (
    <div>
      <div className='h-36 md:h-48 lg:h-72 bg-[url("/cover.jpg")] bg-cover bg-center px-3'>
        <div className='pt-32 md:pt-36 lg:pt-48'>
          <div className='relative flex flex-col md:items-start md:flex-row bg-white p-5 rounded-xl shadow-md lg:max-w-6xl lg:mx-auto'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='text-center md:text-left text-gray-500 py-4'>
                Frontend Developer, based in Palembang, Indonesia
              </p>
            </div>
